...
<p className="sm: w-full font-custom text-xl  font-semibold text-center sm:text-left sm:text-2xl sm:font-bold ">ToDo App</p>
...
<div className="sm:flex-col sm:text-left sm:space-y-8  space-y-8 sm:w-full">
<p className=" font-custom text-xl  font-semibold text-center sm:text-left sm:text-2xl sm:font-bold ">CODEYOGI-Clone</p>
...
<div className="sm:flex-col sm:text-left sm:space-y-8 space-y-8 sm:w-full">
<p className="font-custom text-xl  font-semibold text-center sm:text-left sm:text-2xl sm:font-bold ">Ask Jud</p>
