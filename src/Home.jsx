...
<p className="font-custom text-center text-lg sm:text-2xl sm:px-20 tracking-wider text-center ">A Frontend focused Web Developer building the Frontend of Websites and Web Applications that leads to the success of the overall product
</p>
